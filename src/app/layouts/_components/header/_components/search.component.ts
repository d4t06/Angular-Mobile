...
const classes = {
  input:
    'placeholder:text-[#808080] py-[5px] px-[10pox] w-full font-[500] outline-none text-[#333]',
  searchItem:
  ...
  searchResultContainer:
    'max-h-[60vh] overflow-auto overflow-x-hidden space-y-[10px]',
};
...
export class Search {
  ...
  ngOnInit() {
    this.searchKey.pipe(debounceTime(500)).subscribe((searchKey) => {
      ...
      this.http
        .get<{ data: ProductSearchResponse }>(
